...
export default function Portfolio() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 font-sans px-4 py-12 md:px-24">
      <div className="max-w-4xl mx-auto space-y-12">
        
        {/* Header / Hero Section */}
        <header className="text-center space-y-4 py-10 border-b border-slate-800">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">
            Mulyani Indriati
          </h1>
        ...
        {/* Tentang Saya */}
        <section className="bg-slate-900/60 p-6 md:p-8 rounded-2xl border border-slate-800 shadow-xl">
          <h2 className="text-2xl font-bold text-blue-400 mb-4 border-b border-slate-800 pb-2">
            Tentang Saya
          </h2>
        ...
        {/* Keahlian */}
        <section className="bg-slate-900/60 p-6 md:p-8 rounded-2xl border border-slate-800 shadow-xl">
          <h2 className="text-2xl font-bold text-blue-400 mb-6 border-b border-slate-800 pb-2">
            Keahlian
          </h2>
